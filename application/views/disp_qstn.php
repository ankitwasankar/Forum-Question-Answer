<div class="main_block">
		...
		<div class="qstn">
			...
			<div align="right" class="ask_time"><p>This question is asked by <?php echo "<a href=\"".base_url()."index.php/Guest/view_user/".$obj_1->uid."\">".$obj_1->nickname."</a> on ".date('d-M-Y',$obj_1->time) ?></p></div>
		</div>
		</p>	
		<!-- All replies	-->
		<!-- ********** -->
